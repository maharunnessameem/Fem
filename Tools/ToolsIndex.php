<?php
    ...
    $query = "SELECT * FROM posts WHERE posttype LIKE 'SellPost' ORDER BY postid DESC";
...
<body>
  ...
  <div class="nav_bar">
    ...
    <a class = "active"  href="../Tools/ToolsIndex.php"> Tools </a>
    <a href="../Discussion/DisIndex.php"> Discussion </a>
  ...
  <div class="modal-content">
    <span class="close">&times;</span>
     ...
     <textarea class="descript" rows="100" cols="100" name="Description" placeholder="Description"></textarea>
